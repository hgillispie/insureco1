...
export default function SignUpPage() {
  ...
  const validateStep = (step) => {
    ...
    if (step === 0) {
      ...
      if (!formData.insuranceType) newErrors.insuranceType = 'Please select a coverage option';
    }
  ...
  const renderStepContent = () => {
    switch (currentStep) {
      case 0:
        return (
          <div className="signup-step">
            <Heading className="signup-step__title">Personal Information</Heading>
      ...
      case 1:
        return (
          <div className="signup-step">
            <Heading className="signup-step__title">Your Address</Heading>
      ...
      case 2:
        return (
          <div className="signup-step">
            <Heading className="signup-step__title">What Will You Insure</Heading>
            ...
            <TileGroup
              ...
              legend=""
            >
              <RadioTile className="insurance-tile" value="car">
                <div className="insurance-tile__content">
                  <svg className="insurance-tile__icon" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="insurance-tile__text">
                    ...
                    <span className="insurance-tile__subtitle">Get comprehensive coverage for your vehicle</span>
                  </div>
                </div>
              </RadioTile>

              <RadioTile className="insurance-tile" value="home">
                <div className="insurance-tile__content">
                  <svg className="insurance-tile__icon" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="insurance-tile__text">
                    ...
                    <span className="insurance-tile__subtitle">Protect your most important asset for your family</span>
                  </div>
                </div>
              </RadioTile>

              <RadioTile className="insurance-tile" value="both">
                <div className="insurance-tile__content">
                  ...
                  <div className="insurance-tile__text">
                    ...
                    <span className="insurance-tile__subtitle">Insure both and get bundle savings</span>
                  </div>
                </div>
              </RadioTile>
            </TileGroup>
            ...
            {errors.insuranceType && (
              <p className="insurance-tile-group__error">{errors.insuranceType}</p>
            )}
          </div>
        );
  ...
  return (
    <Grid fullWidth className="signup-page">
      ...
      {showSuccess && (
        <Column lg={12} lgOffset={2} md={8} sm={4} className="signup-page__notification-section">
          <InlineNotification
            kind="success"
            title="Sign up complete"
            subtitle="Your account has been created. Redirecting to your dashboard..."
            hideCloseButton
      ...
      <Column lg={12} lgOffset={2} md={8} sm={4}>
        <Tile className={`signup-page__card ${shakeStep ? 'signup-page__card--shake' : ''}`}>
          <div key={currentStep} className="signup-page__step-transition">
            {renderStepContent()}
          </div>
          ...
          <div className="signup-page__footer">
            ...
            <div className="signup-page__footer-spacer" />
